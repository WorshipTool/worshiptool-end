...
import {
  ...
  GETTER_SOURCES_REPOSITORY,
  GETTER_DOMAIN_REPOSITORY,
  GETTER_SEARCH_REPOSITORY,
  GETTER_SUBURL_REPOSITORY,
  GETTER_EXPLORE_REPOSITORY,
  URL_ALIAS_REPOSITORY,
} from './constants';
...
export const EntitiesProvider = [
  {
    ...
    useFactory: (dataSource: DataSource) =>
      dataSource.getRepository(SongVariant),
    inject: ['DATA_SOURCE'],
  },
  {
  ...
  },
  {
    ...
    useFactory: (dataSource: DataSource) =>
      dataSource.getRepository(PlaylistItem),
    inject: ['DATA_SOURCE'],
  },
  {
    provide: GETTER_SOURCES_REPOSITORY,
    useFactory: (dataSource: DataSource) =>
      dataSource.getRepository(GetterSource),
    inject: ['DATA_SOURCE'],
  },
  {
    provide: GETTER_DOMAIN_REPOSITORY,
    useFactory: (dataSource: DataSource) =>
      dataSource.getRepository(GetterDomain),
    inject: ['DATA_SOURCE'],
  },
  {
    provide: GETTER_SEARCH_REPOSITORY,
    useFactory: (dataSource: DataSource) =>
      dataSource.getRepository(GetterSearch),
    inject: ['DATA_SOURCE'],
  },
  {
    provide: GETTER_SUBURL_REPOSITORY,
    useFactory: (dataSource: DataSource) =>
      dataSource.getRepository(GetterSubUrl),
    inject: ['DATA_SOURCE'],
  },
  {
    provide: GETTER_EXPLORE_REPOSITORY,
    useFactory: (dataSource: DataSource) =>
      dataSource.getRepository(GetterExplore),
    inject: ['DATA_SOURCE'],
  },
  {
    provide: URL_ALIAS_REPOSITORY,
    useFactory: (dataSource: DataSource) => dataSource.getRepository(UrlAlias),
    inject: ['DATA_SOURCE'],
  },
];
