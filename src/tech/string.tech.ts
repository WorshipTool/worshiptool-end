...
/**
 * Returns relative similarity of two strings
 * Returns 1 if strings are equal, 0 if they are completely different
 * @param s1
 * @param s2
 * @param normalizeCzech
 * @returns
 */
export const calculateSimilarity = (
    s1: string,
    s2: string,
    normalizeCzech: boolean = true
) => {
    if (normalizeCzech) {
